...
const ENEMY_AI_CONSTANTS = {
    ...
    INTENT_MIN_DURATION: 1.5,
    INTENT_MAX_DURATION: 3.5,
    INTENT_RANDOM_NOISE: 0.25,
    ACTION_RANDOM_NOISE: 0.35,
    SUPPORT_LOW_HP_THRESHOLD: 0.65,
    RETREAT_HP_THRESHOLD: 0.3,
    INTENT_PERSONALITY_VARIANCE: 0.25,
    CHAOTIC_INTENT_CHANCE: 0.04,
    ACTION_SELECTION_VARIANCE: 0.3,
    ACTION_PREF_VARIANCE: 0.35,
    MICRO_SPEED_JITTER: 0.08
};
...
const STATUS_EFFECT_CONSTANTS = {
    ...
    POISON_BASE_DPS: 8,
    POISON_MAX_STACKS: 4,
    POISON_HEALING_REDUCTION: 0.15,
    POISON_BURN_SYNERGY: 0.25,
...
const SKILL_POOL = {
    ...
    toxic_aura: {
        ...
        name: '猛毒のオーラ',
        type: 'passive',
        description: 'Poisons enemies within 2.5 tiles and weakens healing',
        rarity: 'rare',
        effect: { type: 'poison_aura', range: 2.5, duration: 4, dps: 7, healingReduction: 0.2, interval: 4 }
    },
    venom_spread: {
        id: 'venom_spread',
        name: '猛毒の拡散',
        type: 'passive',
        description: 'Poisoned kills spread venom to nearby foes',
        rarity: 'epic',
        effect: { type: 'poison_spread', range: 2.5, duration: 3, dps: 8, damageRatio: 0.6 }
    },
    flamebrand: {
        id: 'flamebrand',
        name: '炎の烙印',
        type: 'passive',
        description: '40% chance to ignite targets (3s / 14 DPS)',
        rarity: 'rare',
        effect: { type: 'burn_strike', chance: 0.4, duration: 3, dps: 14 }
    },
    wildfire_ritual: {
        id: 'wildfire_ritual',
        name: '業火の儀式',
        type: 'passive',
        description: 'Burning enemies can erupt and spread fire around them',
        rarity: 'epic',
        effect: { type: 'burn_chain', chance: 0.35, range: 2.5, duration: 3, dps: 12 }
    },
    phantom_reach: {
        id: 'phantom_reach',
        name: '幽霊の手のスイング',
        type: 'passive',
        description: 'Extends basic attacks to 7 tiles regardless of weapon',
        rarity: 'epic',
        effect: { type: 'range_override', rangeTiles: 7 }
    },
    skyfall_strike: {
        id: 'skyfall_strike',
        name: 'スカイフォールストライク',
        type: 'passive',
        description: 'Every 8s smites a random foe anywhere and ignites them',
        rarity: 'epic',
        effect: {
            type: 'global_strike',
            interval: 8,
