...
const SOUL_INVESTMENT_CONSTANTS = {
    EXP_PER_SOUL: 100,
    MIN_SOUL_SPEND: 1,
    SKILL_BASE_COST: 500,
    SKILL_PER_LEVEL_COST: 80,
    SKILL_PER_SKILL_COST: 300,
    SKILL_MIN_COST: 800,
...
const SKILL_POOL = {
    ...
    toxic_aura: {
        ...
        description: '周囲2.5タイルの敵を毒状態にし、回復効果を弱体化',
    ...
    venom_spread: {
        ...
        description: '毒状態の敵を倒すと周囲の敵に猛毒が拡散',
    ...
    flamebrand: {
        ...
        description: '40%の確率で対象を炎上させる(3秒間、毎秒14ダメージ)',
    ...
    wildfire_ritual: {
        ...
        description: '炎上中の敵が爆発し、周囲に炎を拡散させる',
    ...
    phantom_reach: {
        ...
        description: '武器に関係なく基本攻撃の射程が7タイルに延長',
    ...
    skyfall_strike: {
        ...
        description: '8秒毎にランダムな敵に天罰を下し、炎上させる',
